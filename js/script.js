const global = {
  ...
  api: {
    apiKey: 'c93cd96f773abab2a43e39f3adbac115',
...
async function displayShowDetails() {
  ...
  div.innerHTML = `
    ...
    <div class="details-bottom">
      <h2>Show Info</h2>
      <ul>
        <li><span class="text-secondary">Number Of Episodes:</span> ${show.number_of_episodes.toLocaleString()}</li>
        <li>
          <span class="text-secondary">Last Episode To Air:</span> ${show.last_episode_to_air.air_date + ', ' + show.last_episode_to_air.name}
        </li>
